...
parser.add_argument("arg_pair", help="Please enter a valid cryptocurrency pair like xrpusd")
args = parser.parse_args()
# Tick a single currency pair (xxx/usd) to the console.
if __name__ == '__main__':
    while True:
        api_response = dict(requests.get('https://api.bitfinex.com/v1/pubticker/' + args.arg_pair).json())
        #print(api_response)
